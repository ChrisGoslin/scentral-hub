...
Resolve the repository root with `git rev-parse --show-toplevel`, then read and follow `<repo-root>/.claude/skills/repo-tidy/SKILL.md`. This wrapper exists only for cross-CLI discovery; do not duplicate or redefine the workflow here.

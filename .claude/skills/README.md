...
|---|---|---|
| `loop-orchestrator` | Select and run proportionate quick, standard, or assured delivery loops with independent critique, evidence gates, and lesson routing. | Partially — keep the mode thresholds and completion record aligned with `AGENTS.md`; do not add project doctrine to the skill. |

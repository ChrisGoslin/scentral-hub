...
const STORAGE_KEY = 'scentral_layering_state';
...
export default function LayeringLab() {
  ...
  // Compute harmony whenever fragrances change
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Layering Lab</h1>
          <p className="text-gray-400">Combine fragrances and discover harmony scores</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold">Select Fragrances</h2>
              <button
                onClick={loadPreset}
        ...
        {state.fragrances.some(f => f !== null) && (
          <div className="mt-12 pt-8 border-t border-gray-700">
            <h2 className="text-xl font-semibold mb-6">Note Breakdown</h2>
    ...
    <div className="relative">
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
        <div className="flex justify-between items-center mb-3">
          <span className="text-sm text-gray-400 font-medium">Slot {index + 1}</span>
          {selected && (
            <button
              onClick={onRemove}
    ...
    <div className="sticky top-6 bg-gray-800 border border-amber-700 rounded-lg p-6 space-y-4">
      ...
      {fragranceCount >= 2 ? (
        ...
        <p className="text-sm text-gray-400 text-center py-8">
          Select 2+ fragrances to see score
        </p>
      )}
    </div>
  );

...
export const metadata: Metadata = {
  ...
  description: 'The nota. User Agreement. Terms governing your use of the app.',
}
    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 20px', color: 'var(--text)', lineHeight: '1.6' }}>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ marginBottom: 12 }}>
          nota. is licensed for your personal, non-commercial use only. You agree that you will not:
        </p>
        <ul style={{ marginLeft: 20, marginTop: 8 }}>
          ...
          <li style={{ marginBottom: 6 }}>Use the App to compete with nota. or build a derivative service</li>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ marginBottom: 12 }}>
          nota. may contain links to fragrance retailers and e-commerce sites. Some of these links
          are affiliate links, meaning:
        </p>
        <ul style={{ marginLeft: 20, marginTop: 8 }}>
          <li style={{ marginBottom: 6 }}>nota. earns a small commission if you purchase through these links</li>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ marginBottom: 12 }}>
          Any content you contribute to nota. (e.g., custom collection names, scent memories,
          layering notes) is subject to the following:
        </p>
        <ul style={{ marginLeft: 20, marginTop: 8 }}>
          <li style={{ marginBottom: 6 }}>You retain ownership of your content</li>
          <li style={{ marginBottom: 6 }}>You grant nota. a non-exclusive license to use, store, and display it</li>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ marginBottom: 12 }}>
          <strong>TO THE MAXIMUM EXTENT PERMITTED BY LAW, NOTA. IS NOT LIABLE FOR:</strong>
        </p>
        <ul style={{ marginLeft: 20, marginTop: 8 }}>
        ...
        <p style={{ marginTop: 12 }}>
          ...
          nota. has been advised of the possibility of such damages.
        </p>
      </section>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p>
          You agree to indemnify, defend, and hold harmless nota. and its creators from any claims,
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ marginBottom: 12 }}>
          We may terminate or suspend your access to nota. at any time, with or without cause, if:
        </p>
        <ul style={{ marginLeft: 20, marginTop: 8 }}>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p>
          nota. reserves the right to modify, suspend, or discontinue any feature or the entire App
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p>
          ...
          nota. regarding your use of the App. Any other terms or conditions are superseded by this agreement.
        </p>
      </section>

...
import DiscoverClient, { type DiscoverFragrance } from '../discover/DiscoverClient'
import ActiveChallengeSection from '@/components/features/ActiveChallengeSection'

export const metadata: Metadata = {
  title: 'The Study | nota.',
  description: 'Enter The Study to search the nota. fragrance catalogue and follow the bottles that match your scent identity.',

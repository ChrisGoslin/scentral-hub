...
export default function DisclaimerPage() {
  const sections = [
    ...
    },
    {
      ...
      body: 'AnotherSense and its creator accept no liability for adverse reactions, skin irritation, or any harm arising from fragrance application based on suggestions in this tool. Use at your own discretion.',
    },
    {
      heading: 'About AnotherSense',
      body: 'AnotherSense is an independent hobby project. It is not affiliated with, endorsed by, or connected to any fragrance brand or retailer mentioned within the app.',
    },
  ]

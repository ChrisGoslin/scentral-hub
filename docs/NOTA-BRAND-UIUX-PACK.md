...
--pig-taupe       #766E64   memory, history, anatomy line work
...
| metadata `--ink-quiet` | taupe `#766E64` | 10.35:1 | taupe `#766E64` | 12.2:1 |
| atmospheric `--ink-faint` | taupe-ink `#756A5C` | 4.82:1 | taupe-ink `#756A5C` | 5.8:1 |
...
**Rule:** taupe `#766E64` is 10.35:1 on ivory, meeting WCAG AA for any text size.
Use taupe for primary metadata text. For extra contrast on complex backgrounds,
use `taupe-ink` `#756A5C` (4.82:1). If an element carries information, it must
clear at least 4.5:1 against its ground.

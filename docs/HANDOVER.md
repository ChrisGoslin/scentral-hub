...
> - **Taupe hex — RESOLVED 2026-07-26 (complete).** `#766E64` (10.35:1 on ivory, clears WCAG AA for any text) is now the single canonical value across `DESIGN.md`, `NOTA_MANIFESTO.md`, `NOTA-BRAND-UIUX-PACK.md`, `docs/brand/nota-imagery-briefs.md`, `docs/nota/09-brand-design-handover.md`, and shipped `app/globals.css`. The old `#B8AC9C` (2.03:1 atmospheric-only value) is fully retired; all docs and code are aligned.
>

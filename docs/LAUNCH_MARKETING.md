...
- **Psychographics:**
  - Distrusts influencer beauty culture
  - Values personal identity over trend-following
  - Enjoys rituals and intentional living
  - Willing to spend on quality but skeptical of "premium" branding
  - Active on: TikTok (for culture, not purchasing), Instagram (aesthetic, not ads), Reddit (r/fragrance), Indie podcast communities
  - Reads: Kinfolk, Substack indie culture newsletters, Medium essays on identity
- **Pain Points:**
  - Too many fragrances; hard to remember which ones I love
  - Fragrance recs are biased (influencers paid, friends' taste ≠ mine)
  - Want to track mood + scent over time (ritual awareness)
  - Embarrassed to pay $150+ for a fragrance I'll forget about in 3 months
- **Aspirations:**
  - Build a meaningful fragrance collection (not a closet)
  - Understand *why* I'm drawn to certain scents
  - Use fragrance as a tool for mood/identity intentionality
  - Share scent stories with friends (without it feeling like hawking)
...
✦ Blind Ranking — Find your true favorites
✦ Scent Traces — Journal moments with each fragrance
✦ Your Insights — Discover your scent personality
...
1. Blind Rank your current collection (takes 5 min)
2. Log a Scent Trace tomorrow morning (capture your ritual)
3. Check your insights—see your persona emerge

Next up: Spritz Schedule (daily AI suggestions) ships next week.

Questions? Ideas? We read every reply.
...
### 4. Win-Back Email (For Inactive Users, Week 3)

**Subject:**
- "We shipped something for you—Spritz Schedule"
- "Your collection's waiting"

**Segment:** Users who installed but haven't opened in 7+ days
...
### Instagram Content Pillars (Post Captions)

#### Pillar 1: "Why Fragrance Matters" (Anti-influencer education)
**Posts 1, 4, 7, etc.**
...
[User photo of shelf + screenshot of their insight]
```

#### Pillar 3: "Feature Tips" (How-tos, product depth)
**Posts 3, 6, 9, etc.**
...
- **Content:** Show before/after; reveal surprise ranking
- **Engagement:** Relatable shock moment (viewer identifies)
- **Duration:** 30–45 sec
- **CTA:** "Try blind ranking. It's wild."

#### Series 3: "Fragrance Takes Nobody Asked For" (Hot takes)
- **Hook:** "unpopular opinion: compliments don't mean the fragrance is good *for you*"
- **Content:** 1–2 quick fragrance culture critiques (sarcastic, sharp)
- **Engagement:** Niche audience (r/fragrance, indie beauty community)
- **Duration:** 15 sec
...
### Twitter/X Tweets (Daily Thread Examples)
...
so we made a tool that does one thing: help you know your taste.
...
• Your Insights: Personalized scent personality based on preference patterns
...
ABOUT NOTA.
nota. builds tools for personal identity and intentional living.
...
## Paid Social Ad Copy (Optional, if budget permits)
...
- **Emotional payoff:** Screenshot of Insight card reveal
- **CTA:** "It's free. No login."

---

## Waitlist Funnel (Pre-Launch)
...
### Launch Week Goals
- **Downloads:** 100+ (aggressive goal: 250+)
- **Waitlist → Install conversion:** 30%+
- **D1 Retention:** 20%+ (return within 24 hours)
- **Email open rate:** 35%+
- **Social media reach:** 5k–10k impressions on launch announcement posts
...
### Milestone Markers
- **Week 2:** Launch Spritz Schedule feature (increase re-engagement)
- **Week 3:** Ship first "How to Get Started" video series (YouTube Shorts)
- **Week 4:** Highlight top user stories (media + social)
- **Month 2:** Plan Phase 8 features (social sharing, gifting)

---

## Contingency: Low Launch Response

If first week is slow (<50 installs):
1. **Double down on TikTok** — Organic reach is free; ship 2–3 viral-ready videos
2. **Reactivate email list** — Resend to open-but-non-converters with social proof
3. **Fragrance community outreach** — Reddit AMAs, indie beauty Slack groups, podcast guests
4. **Press follow-up** — HubSpot/email pitch to tech/lifestyle journalists (missed initial press?)
5. **User interviews** — Talk to 5–10 waitlist no-shows; understand barriers

---

*Marketing templates prepared for Phase 7 launch. Update after 2-week post-launch review based on cohort data.*

...
## T+0 (Launch Day) — Main Announcement
...
```
Quick demo: 15 seconds to your persona.

The Sanctuary Profiler asks one thing:
where are you when the world gets loud?

Your answer becomes your fragrance DNA.

(Yes, it actually nails it.)
```
...
## T+1 (Day 2) — Social Proof + User Hook
...
Lattafa, Niche, Rasasi—brands Western fragrance folks don't know about.

We've mapped 200+ dupes.
...
Now: take your persona, get your wardrobe, find your dupes.

Tell me what your persona is. Mine's Velvet Intellectual.
```

---

## T+3 (Day 3) — Feature Deep-Dive (Thread)
...
✦ 40% immediately add a bottle to their wardrobe
✦ The most-added bottle is a £18 Lattafa (not a £150 Creed)
...
## T+7 (End of Week) — Community Building

**Tweet 8**
```
What's your fragrance personality?

RT if you're a Velvet Intellectual (moody, niche-leaning)
...
## Scheduling Notes
- **Launch Day (T+0):** Post Tweets 1–3 live (check comments every 2 hours)
- **Day 2 (T+1):** Queue Tweets 4–5 (9am, 2pm)
- **Day 3 (T+3):** Post Thread (Tweet 6) live (7pm optimal)
- **Day 5 (T+5):** Queue Tweet 7 (9am with screenshot of metrics)
- **End of Week (T+7):** Queue Tweet 8 (2pm, high engagement time)

Use Buffer/Later for scheduling. Keep desktop open on launch day for live engagement.

...
- `docs/BRAND-RULING-hero-video.md`, `docs/DESIGN.md`, `docs/NOTA-BRAND-UIUX-PACK.md`, `docs/lessons.md` — referenced by the homepage/hero Prompts 0–5; confirm Prompt 0 has actually placed these before assuming they exist at these paths.

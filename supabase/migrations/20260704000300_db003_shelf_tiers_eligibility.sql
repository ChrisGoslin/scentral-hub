...
-- under its original version (docs/HANDOVER.md). Every step guarded/made
-- idempotent so it no-ops there instead of aborting on the first
-- duplicate object and blocking every migration after it.

// Canonical shared logic between app/(main)/insights/page.tsx (Next.js/Node,
// via the lib/insights-impact.ts re-export) and
// supabase/functions/compute-insights-nightly/index.ts (Deno). Lives in
// supabase/functions/_shared per Supabase's documented convention
// (https://supabase.com/docs/guides/functions/development-tips) — that's the
// only directory their deploy bundler is guaranteed to walk. Keep this file
